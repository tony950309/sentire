...
public class libvibptn extends AppCompatActivity implements View.OnClickListener {

    Button btndel,btnset,btnsave,btnedit;
    TextView tvbtnemot,tvcode,tvbtnclear,tvbtnnew;
    EditText etname;
    ImageButton imbtnhelp;
    ImageView imbtnLVrefresh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_libvibptn);
        setTitle("                              Library Vibration Pattern List");
...
//        btnflt     = (Button) findViewById(R.id.btnLVfilter);
        btndel     = (Button) findViewById(R.id.btnLVdel);
        btnset     = (Button) findViewById(R.id.btnLVsetas);
        btnsave    = (Button) findViewById(R.id.btnLVsave);
        btnedit    = (Button) findViewById(R.id.btnLVedit);

        etname     = (EditText) findViewById(R.id.etLVptnname);
        tvbtnemot  = (TextView) findViewById(R.id.tvbtnLVptnemot);
        tvcode     = (TextView) findViewById(R.id.tvbtnLVptncode);
        tvbtnclear = (TextView) findViewById(R.id.tvbtnLVclear);
        tvbtnnew   = (TextView) findViewById(R.id.tvbtnLVnew);
        imbtnhelp  = (ImageButton) findViewById(R.id.imbtnLVhelp);
        imbtnLVrefresh = (ImageView) findViewById(R.id.imbtnLVrefresh);
...
//        btnflt.setOnClickListener(this);
        ...
        imbtnLVrefresh.setOnClickListener(this);
        initptn();
...
//                break;
            case R.id.imbtnLVhelp:
                AlertDialog.Builder builder1 = new AlertDialog.Builder(libvibptn.this);
                ...
                builder1.setMessage(
                    ...
                    "If you want to add more library sequence to this pattern, just click 'edit code'" + "\n" + "\n" +
                ...
                break;
            case R.id.tvbtnLVptnemot:
                if(isselected) {
                    AlertDialog.Builder builder2 = new AlertDialog.Builder(libvibptn.this);
                ...
                if(isselected) {
                    ...
                    builder3.setPositiveButton("Delete", new DialogInterface.OnClickListener() { //设置确定按钮
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Toast.makeText(libvibptn.this, "Delete succeed", Toast.LENGTH_SHORT).show();
                            for (int i = 0; i <= existingPtnNumb; i++) {
                                mylist.remove(0);
                            }
                            initptn();
            ...
            case R.id.btnLVsetas:
                if(isselected) {
                    ...
                    msg("Set as " + data_s[2] + " vibration pattern!");
                }else
                    msg("Select one pattern before editing!");
                break;
            case R.id.btnLVsave:
            ...
            case R.id.btnLVedit:
                if (isselected) {
                    ...
                    Intent i = new Intent(libvibptn.this, libvibcreate.class);
                    startActivity(i);
